...
const SingleStory = () => {
	...
	<div>
		<img src={imgUrl} alt="" className="object-cover w-full mb-4 h-60 sm:h-96 dark:dark:bg-gray-500" />
	...
	<div className="flex flex-wrap justify-between">
		...
		<div className="flex space-x-2 text-sm dark:dark:text-gray-400">
			...
			<button type="button" className="flex items-center p-1 space-x-1.5">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-label="Number of likes" className="w-4 h-4 fill-current dark:dark:text-violet-400">
